...
<section class="panel p-3 dashboard-card dashboard-work-status-card d-flex flex-column">
    <div class="dashboard-panel-header d-flex align-items-start justify-content-between gap-2 mb-3">
        <div class="min-w-0">
            ...
            <div class="small text-secondary">08:00-17:59 intervalı üzrə Engine hours</div>
        </div>
    ...
    <div class="dashboard-work-status-note mb-2">
        Hesablama vahidi: Texnika-gün<br>
        İş vaxtı: 08:00-17:59<br>
                ...
                <table class="table table-sm align-middle mb-0">
                    ...
                    @foreach ($statuses as $status)
                        <tr
                            ...
                            role="button"
                            tabindex="0"
                            data-drilldown-title="Gündüz effektivliyi — {{ $categoryLabels[$status] }}"
                            data-drilldown-ownership="{{ $drilldownOwnership }}"
                            data-drilldown-mode="daytime_efficiency_projects"
