...
class WialonReportStatsSyncService
{
    ...
    public function syncDailyEngineHoursReport(array $filters, bool $force = false): array
    {
        ...
        return $this->syncDailyReportForGroup($filters, $group, $syncKey);
    }
    ...
    private function syncDailyReportForGroup(array $filters, object $group, string $syncKey): array
    {
        ...
        $mileageEquipmentIds = [];
        $ownershipType = (string) $group->ownership_type;
        ...
        if ($reportData === null) {
            throw new RuntimeException($filters['project_id']
    ...
    private function wialonDailyEngineHoursSyncKey(array $filters, array $settings, ProjectWialonGroup $group): string
    {
