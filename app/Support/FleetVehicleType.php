...
final class FleetVehicleType
{
    ...
    public const MONTHLY_OBJECT_EFFICIENCY_TYPES = self::EFFICIENCY_TYPES;
    ...
    public static function aliases(): array
    {
        return [
            ...
            'бульдозер' => self::BULLDOZER,
            'экскаватор' => self::EXCAVATOR,
            'погрузчик' => self::LOADER,
            'экскаватор_погрузчик' => self::BACKHOE_LOADER,
            'road-grader' => self::ROAD_GRADER,
            'road grader' => self::ROAD_GRADER,
            'road_grader' => self::ROAD_GRADER,
            'грейдер' => self::ROAD_GRADER,
            'автогрейдер' => self::ROAD_GRADER,
            'road-roller' => self::ROAD_ROLLER,
            'road roller' => self::ROAD_ROLLER,
            'road_roller' => self::ROAD_ROLLER,
            'каток' => self::ROAD_ROLLER,
            'дорожный_каток' => self::ROAD_ROLLER,
            'dump-truck' => self::DUMP_TRUCK,
            'dump truck' => self::DUMP_TRUCK,
            'dump_truck' => self::DUMP_TRUCK,
            'самосвал' => self::DUMP_TRUCK,
        ];
    }
