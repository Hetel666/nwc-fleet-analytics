...
class MonthlyEfficiencyDashboardController extends Controller
{
    ...
    public function units(
        ...
        return [
            ...
            'columns' => [
                ...
                'project' => 'Layihə',
                'period' => 'Layihədə dövr',
                'synced_days_count' => 'Layihədə gün',
                'current_hours' => 'Layihə üzrə MS',
                'normative_hours' => 'Normativ MS',
                'efficiency_percent' => 'Effektivlik %',
                'project_source_label' => 'Layihə mənbəyi',
    ...
    private function filters(Request $request): array
    {
        return $request->validate([
            ...
            'sort' => ['nullable', Rule::in(['date', 'name', 'registration_number', 'project', 'actual_project', 'vehicle_type', 'ownership', 'current_hours', 'normative_hours', 'efficiency_percent', 'status', 'total_hours', 'known_hours', 'unknown_hours', 'mileage', 'motosaat', 'yurush', 'visits'])],
