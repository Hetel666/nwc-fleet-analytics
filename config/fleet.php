...
return [
    'wialon' => [
        ...
        'shift_engine_hours_report_template_name' => env('WIALON_SHIFT_ENGINE_HOURS_REPORT_TEMPLATE_NAME', env('WIALON_SHIFT_REPORT_TEMPLATE_NAME', 'Qrup report Engine hours (api)')),
