...
return [
    'wialon' => [
        ...
        'actual_work_report_timeout' => (int) env('WIALON_ACTUAL_WORK_REPORT_TIMEOUT', 120),
        ...
        'geofence_outside_report_timeout' => (int) env('WIALON_GEOFENCE_OUTSIDE_REPORT_TIMEOUT', 45),
