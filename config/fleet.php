...
return [
    'wialon' => [
        ...
        'shift_report_template_name' => env('WIALON_SHIFT_REPORT_TEMPLATE_NAME', 'Qrup report Engine hours (api)'),
        'shift_engine_hours_report_resource_id' => (int) env('WIALON_SHIFT_ENGINE_HOURS_REPORT_RESOURCE_ID', env('WIALON_SHIFT_REPORT_RESOURCE_ID', env('WIALON_ENGINE_HOURS_REPORT_RESOURCE_ID', 601701680))),
        'shift_engine_hours_report_template_id' => (int) env('WIALON_SHIFT_ENGINE_HOURS_REPORT_TEMPLATE_ID', env('WIALON_SHIFT_REPORT_TEMPLATE_ID', env('WIALON_ENGINE_HOURS_REPORT_TEMPLATE_ID', 9))),
        'shift_engine_hours_report_template_name' => env('WIALON_SHIFT_ENGINE_HOURS_REPORT_TEMPLATE_NAME', env('WIALON_ENGINE_HOURS_REPORT_TEMPLATE_NAME', 'Engine hours: NWC vs İCARƏ (Api)')),
        'shift_daytime_report_resource_id' => (int) env('WIALON_SHIFT_DAYTIME_REPORT_RESOURCE_ID', env('WIALON_SHIFT_REPORT_RESOURCE_ID', env('WIALON_ACTUAL_WORK_REPORT_RESOURCE_ID', env('WIALON_ENGINE_HOURS_REPORT_RESOURCE_ID', 601701680)))),
        'shift_daytime_report_template_id' => (int) env('WIALON_SHIFT_DAYTIME_REPORT_TEMPLATE_ID', 0),
        'shift_daytime_report_template_name' => env('WIALON_SHIFT_DAYTIME_REPORT_TEMPLATE_NAME', 'Qrup report daytime (api)'),
        'shift_overtime_report_resource_id' => (int) env('WIALON_SHIFT_OVERTIME_REPORT_RESOURCE_ID', env('WIALON_SHIFT_REPORT_RESOURCE_ID', env('WIALON_ACTUAL_WORK_REPORT_RESOURCE_ID', env('WIALON_ENGINE_HOURS_REPORT_RESOURCE_ID', 601701680)))),
        'shift_overtime_report_template_id' => (int) env('WIALON_SHIFT_OVERTIME_REPORT_TEMPLATE_ID', 0),
        'shift_overtime_report_template_name' => env('WIALON_SHIFT_OVERTIME_REPORT_TEMPLATE_NAME', 'Qrup report overtime (api)'),
