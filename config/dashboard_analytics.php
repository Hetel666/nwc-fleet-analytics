...
return [
    ...
    'widgets' => [
        ...
        [
            ...
            'dashboard_block' => 'Donut yalnız 3 daytime statusu; Cəmi onların cəmidir. Overtime, >10 ümumi saat və məlumatsız texnika ayrıca sayılır.',
            'wialon_report' => 'Qrup report daytime (api) + Qrup report overtime (api)',
            ...
            'report_rows' => [
                ...
                'over_10_hours is a supplemental indicator where total_hours > 10',
            ...
            'excel' => 'Excel faizsiz daytime statuslarını, Cəmi və əlavə göstəriciləri eyni service ilə çıxarır.',
        ],
        [
